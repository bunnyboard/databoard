        ...
        for (const offer of event.args.offer.concat(event.args.consideration)) {
          ...
          if (offer.itemType === 0 || offer.itemType === 1) {
            ...
            if (token) {
              ...
              (protocolData.volumeMarketplace as any).sale += tokenAmountUsd;
              ...
              (protocolData.breakdown[token.chain][token.address].volumeMarketplace as any).sale += tokenAmountUsd;
