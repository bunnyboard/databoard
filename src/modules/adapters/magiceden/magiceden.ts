...
//             formatBigNumberToNumber(event.args.salePrice.toString(), token.decimals) * tokenPriceUsd;

//           (protocolData.marketplace as any).volumeMarketplace += purchaseAmountUsd;
...
//             };
//           }
//           (protocolData.breakdown[token.chain][token.address].marketplace as any).volumeTrade += purchaseAmountUsd;
