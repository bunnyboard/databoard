...
export const BlockchainConfigs: { [key: string]: Blockchain } = {
  ...
  [ChainNames.bobabnb]: {
    name: ChainNames.bobabnb,
    family: 'evm',
    chainId: 56288,
    nodeRpc: String(process.env.BLOCKCHAIN_BOBABNB_NODE),
    nativeToken: {
  ...
  [ChainNames.abstract]: {
    name: ChainNames.abstract,
    family: 'evm',
    chainId: 2741,
    nodeRpc: String(process.env.BLOCKCHAIN_ABSTRACT_NODE),
    nativeToken: {
  ...
  [ChainNames.b3]: {
    ...
    family: 'evm',
    chainId: 8333,
    nodeRpc: String(process.env.BLOCKCHAIN_B3_NODE),
    nativeToken: {
      chain: ChainNames.b3,
      address: AddressZero,
      symbol: 'ETH',
  ...
  [ChainNames.story]: {
    name: ChainNames.story,
    family: 'evm',
    chainId: 1514,
    nodeRpc: String(process.env.BLOCKCHAIN_STORY_NODE),
    nativeToken: {
  ...
  [ChainNames.hemi]: {
    name: ChainNames.hemi,
    family: 'evm',
    chainId: 43111,
    nodeRpc: String(process.env.BLOCKCHAIN_HEMI_NODE),
    nativeToken: {
  ...
  [ChainNames.corn]: {
    name: ChainNames.corn,
    family: 'evm',
    chainId: 21000000,
    nodeRpc: String(process.env.BLOCKCHAIN_CORN_NODE),
    nativeToken: {
  ...
  [ChainNames.telos]: {
    name: ChainNames.telos,
    family: 'evm',
    chainId: 41,
    nodeRpc: String(process.env.BLOCKCHAIN_TELOS_NODE),
    nativeToken: {
