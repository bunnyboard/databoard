  ...
  diamonds: [
    {
      ...
      tokens: LifiSupportedTokens.filter((item) => item.chain === ChainNames.ethereum),
    },
    {
      ...
      diamond: '0x1231DEB6f5749EF6cE6943a275A1D3E7486F4EaE',
      feeCollector: '0xbD6C7B0d2f68c2b7805d88388319cfB6EcB50eA9',
      tokens: LifiSupportedTokens.filter((item) => item.chain === ChainNames.optimism),
    },
    {
      ...
      diamond: '0x1231DEB6f5749EF6cE6943a275A1D3E7486F4EaE',
      feeCollector: '0xbD6C7B0d2f68c2b7805d88388319cfB6EcB50eA9',
      tokens: LifiSupportedTokens.filter((item) => item.chain === ChainNames.bnbchain),
    },
    {
      ...
      diamond: '0x1231DEB6f5749EF6cE6943a275A1D3E7486F4EaE',
      feeCollector: '0xbD6C7B0d2f68c2b7805d88388319cfB6EcB50eA9',
      tokens: LifiSupportedTokens.filter((item) => item.chain === ChainNames.gnosis),
    },
    {
      ...
      diamond: '0x1231DEB6f5749EF6cE6943a275A1D3E7486F4EaE',
      feeCollector: '0xbD6C7B0d2f68c2b7805d88388319cfB6EcB50eA9',
      tokens: LifiSupportedTokens.filter((item) => item.chain === ChainNames.polygon),
    },
    {
      ...
      tokens: LifiSupportedTokens.filter((item) => item.chain === ChainNames.fantom),
    },
    {
      ...
      tokens: LifiSupportedTokens.filter((item) => item.chain === ChainNames.zksync),
    },
    {
      ...
      tokens: LifiSupportedTokens.filter((item) => item.chain === ChainNames.metis),
    },
    {
      ...
      tokens: LifiSupportedTokens.filter((item) => item.chain === ChainNames.polygonzkevm),
    },
    {
      ...
      diamond: '0x1231DEB6f5749EF6cE6943a275A1D3E7486F4EaE',
      feeCollector: '0xB0210dE78E28e2633Ca200609D9f528c13c26cD9',
      tokens: LifiSupportedTokens.filter((item) => item.chain === ChainNames.moonbeam),
    },
    {
      ...
      tokens: LifiSupportedTokens.filter((item) => item.chain === ChainNames.mantle),
    },
    {
      ...
      tokens: LifiSupportedTokens.filter((item) => item.chain === ChainNames.base),
    },
    {
      ...
      diamond: '0x1231DEB6f5749EF6cE6943a275A1D3E7486F4EaE',
      feeCollector: '0xB0210dE78E28e2633Ca200609D9f528c13c26cD9',
      tokens: LifiSupportedTokens.filter((item) => item.chain === ChainNames.arbitrum),
    },
    {
      ...
      diamond: '0x1231DEB6f5749EF6cE6943a275A1D3E7486F4EaE',
      feeCollector: '0xB0210dE78E28e2633Ca200609D9f528c13c26cD9',
      tokens: LifiSupportedTokens.filter((item) => item.chain === ChainNames.avalanche),
    },
    {
      ...
      tokens: LifiSupportedTokens.filter((item) => item.chain === ChainNames.linea),
    },
    {
      ...
      diamond: '0x1231DEB6f5749EF6cE6943a275A1D3E7486F4EaE',
      feeCollector: '0xF048e5816B0C7951AC179f656C5B86e5a79Bd7b5',
      tokens: LifiSupportedTokens.filter((item) => item.chain === ChainNames.scroll),
    },
    {
      ...
      diamond: '0x1231DEB6f5749EF6cE6943a275A1D3E7486F4EaE',
      feeCollector: '0xF048e5816B0C7951AC179f656C5B86e5a79Bd7b5',
      tokens: LifiSupportedTokens.filter((item) => item.chain === ChainNames.mode),
    },
  ],
};
