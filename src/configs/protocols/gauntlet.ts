...
export interface GauntletCuratorConfig {
  chain: string;
  birthday: number;
  morphoVaults: Array<string>;
  eulerVaults: Array<string>;
}

export interface GauntletProtocolConfig extends ProtocolConfig {
  curators: Array<GauntletCuratorConfig>;
}

export const GauntletConfigs: GauntletProtocolConfig = {
  protocol: ProtocolNames.gauntlet,
  ...
  curators: [
    {
      ...
      birthday: 1714608000, // Thu May 02 2024 00:00:00 GMT+0000
      morphoVaults: [
        '0x8eB67A509616cd6A7c1B3c8C21D48FF57df3d458', // gauntlet-usdc-core
        '0x2371e134e3455e0593363cBF89d3b6cf53740618', // gauntlet-weth-prime
        '0x132E6C9C33A62D7727cd359b1f51e5B566E485Eb', // resolv-usdc
        '0x4881Ef0BF6d2365D3dd6499ccd7532bcdBCE0658', // gauntlet-weth-core
        '0xdC94785959B73F7A168452b3654E44fEc6A750e4', // gauntlet-lbtc-core
        '0xdd0f28e19C1780eb6396170735D45153D261490d', // gauntlet-usdc-prime
        '0x500331c9fF24D9d11aee6B07734Aa72343EA74a5', // gauntlet-dai-core
        '0x443df5eEE3196e9b2Dd77CaBd3eA76C3dee8f9b2', // gauntlet-wbtc-core
